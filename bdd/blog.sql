...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 28 juil. 2021 à 19:33
...
INSERT INTO `comments` (`id`, `content`, `createdAt`, `approvement`, `postId`, `userId`) VALUES
(2, 'A surveillÃ©, ca peut etre intÃ©ressant.', '2021-07-14', 1, 1, 2),
(8, 'C\'est beaucoup trop limitÃ© pour le moment.', '2021-07-22', 1, 1, 1),
(9, 'Justement avec cette levÃ© de fond ils vont pouvoir faire avancer les choses.', '2021-07-26', 0, 1, 3);
...
(2, 'test', 'diot', 'christopher.diot5@gmail.com', '$2y$10$r6SXyvCOCbctuuD/XuIr2uEi94t7xcuJYTF41Qa2YMnIT17XfJQWm', 0),
(3, 'toto', 'tot', 'christ.diot5@gmail.com', '$2y$10$U5lKK9WRopk9Ugz1hS.B8uLhSPqHmk3n52ctrK5m92e7pE2qa/boS', 0),
